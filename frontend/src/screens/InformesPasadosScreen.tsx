...
export default function InformesPasadosScreen({
  onNavigate,
  onLogout,
}: Props) {
  const [reports, setReports] = useState<ResumenInforme[]>([]);
  ...
  const filtered = reports.filter((r) => {
    ...
    const horario = obtenerHorario(r);

    const matchSearch =
      !search ||
      fechaStr.toLowerCase().includes(search.toLowerCase()) ||
      horario.toLowerCase().includes(search.toLowerCase());
        ...
        >
          <div>
            ...
            <p
              ...
              style={{ color: '#5a6a82' }}
            >
              Consulta los informes registrados anteriormente.
            </p>
          </div>
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p
                  ...
                  style={{ color: '#8fa0b8' }}
                >
                  Ajusta los filtros o elabora un nuevo informe.
                </p>
              </div>
            ) : (
              <table className="w-full">
                ...
                <tbody>
                  {filtered.map((r, idx) => {
                    const totalActividades = contarActividades(r);
